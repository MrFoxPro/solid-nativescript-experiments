...
export type TActionBarAttributes = Override<
    ViewAttributes,
    {
...
// ui/action-bar/index.d.ts
export type TActionItemAttributes = Override<
    ViewBaseAttributes,
    {
        actionBar?: ActionBar;
        actionView?: View;
...
export type TActivityIndicatorAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        busy?: string | boolean;
...
export type TButtonAttributes = Override<
    TextBaseAttributes,
    {
...
export type TContainerViewAttributes = Override<
    ViewAttributes,
    {
...
export type TContentViewAttributes = Override<
    CustomLayoutViewAttributes,
    {
        content?: View;
        layoutView?: View;
    }
...
export type TDatePickerAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        date?: string | Date;
...
export type TDockLayoutAttributes = Override<
...
export type TEditableTextBaseAttributes = Override<
    TextBaseAttributes,
    {
...
export type TFlexboxLayoutAttributes = Override<
    LayoutBaseAttributes,
    {
...
export type TFormattedStringAttributes = Override<
    ViewBaseAttributes,
    {
...
// ui/frame/index.d.ts
export type TFrameAttributes = Override<
    FrameBaseAttributes,
    {
...
export type TFrameBaseAttributes = Override<
    CustomLayoutViewAttributes,
    {
        actionBarVisibility?: "always" | "never" | "auto";
        animated?: boolean;
...
export type TGridLayoutAttributes = Override<
    LayoutBaseAttributes,
    {
        columns?: string;
        rows?: string;
...
export type THtmlViewAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        html?: string;
...
// ui/image/index.d.ts
export type TImageAttributes = Override<
    ViewAttributes,
    {
        android?: any;
...
// ui/label/index.d.ts
export type TLabelAttributes = Override<
    TextBaseAttributes,
    {
        android?: any;
        ios?: any;
...
export type TLayoutBaseAttributes = Override<
    CustomLayoutViewAttributes,
    {
...
export type TListPickerAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        ios?: any;
...
export type TListViewAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        ios?: any;
...
// ui/page/index.d.ts
export type TPageAttributes = Override<
    PageBaseAttributes,
    {
...
export type TPageBaseAttributes = Override<
...
export type TPlaceholderAttributes = Override<
    ViewAttributes,
    {
...
export type TProgressAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        ios?: any;
...
export type TProxyViewContainerAttributes = Override<
    LayoutBaseAttributes,
    {
        android?: any;
        ios?: any;
...
export type TRepeaterAttributes = Override<
    CustomLayoutViewAttributes,
    {
        android?: any;
        ios?: any;
...
export type TScrollViewAttributes = Override<
    ContentViewAttributes,
    {
...
export type TSearchBarAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        hint?: string;
...
export type TSegmentedBarAttributes = Override<
    ViewAttributes,
    {
...
// ui/segmented-bar/index.d.ts
export type TSegmentedBarItemAttributes = Override<
    ViewBaseAttributes,
    {
        title?: string;
    }
...
export type TSliderAttributes = Override<
    ViewAttributes,
    {
        accessibilityRole?: AccessibilityRole;
...
export type TSpanAttributes = Override<
    ViewBaseAttributes,
    {
        backgroundColor?: string | Color;
        color?: string | Color;
...
export type TStackLayoutAttributes = Override<
    LayoutBaseAttributes,
    {
        onOrientationChange?: (args: PropertyChangeData) => void;
        orientation?: "horizontal" | "vertical";
...
export type TSwitchAttributes = Override<
    ViewAttributes,
    {
        android?: any;
...
export type TTabViewAttributes = Override<
    ViewAttributes,
    {
        android?: any;
...
// ui/tab-view/index.d.ts
export type TTabViewItemAttributes = Override<
    ViewBaseAttributes,
    {
        canBeLoaded?: boolean;
        iconSource?: string;
...
export type TTextBaseAttributes = Override<
    ViewAttributes,
    {
        fontFamily?: string;
        fontSize?: string | number;
...
export type TTextFieldAttributes = Override<
...
export type TTextViewAttributes = Override<
    EditableTextBaseAttributes,
    {
        android?: any;
        ios?: any;
...
export type TTimePickerAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        hour?: string | number;
...
// ui/core/view/index.d.ts
export type TViewAttributes = Override<
    ViewBaseAttributes,
    {
...
export type TViewBaseAttributes = Override<
...
export type TWebViewAttributes = Override<
    ViewAttributes,
    {
        android?: any;
        canGoBack?: boolean;
...
export type TWrapLayoutAttributes = Override<
    LayoutBaseAttributes,
    {
